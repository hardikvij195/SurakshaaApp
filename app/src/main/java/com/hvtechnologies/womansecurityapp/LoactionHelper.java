...
public class LoactionHelper implements PermisssionUtil.PermissionResultCallback{
    ...
    private PermisssionUtil permissionUtils;
    ...
    public LoactionHelper(Context context) {
        ...
        permissionUtils=new PermisssionUtil(context,this);
